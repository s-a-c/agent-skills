...
curl -fsSL https://raw.githubusercontent.com/s-a-c/agent-skills/main/skills/s-a-c-bypass-shell-aliases/rules/s-a-c-bypass-shell-aliases.md \
  -o ~/.config/agents/rules/s-a-c-bypass-shell-aliases.md
# …or copy from the installed skill folder (path varies by agent/scope), e.g.
cp ~/.agents/skills/s-a-c-bypass-shell-aliases/rules/s-a-c-bypass-shell-aliases.md ~/.config/agents/rules/s-a-c-bypass-shell-aliases.md
```
