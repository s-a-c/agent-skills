...
curl -fsSL https://raw.githubusercontent.com/s-a-c/agent-skills/main/skills/s-a-c-debug-confirmation-gate/rules/debug-confirmation-policy.md \
  -o ~/.config/agents/rules/debug-confirmation-policy.md
# …or copy from the installed skill folder (path varies by agent/scope), e.g.
cp ~/.agents/skills/s-a-c-debug-confirmation-gate/rules/debug-confirmation-policy.md ~/.config/agents/rules/debug-confirmation-policy.md
```
