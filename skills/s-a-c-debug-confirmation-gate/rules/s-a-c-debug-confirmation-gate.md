...
Always-on wrapper for the **`s-a-c-debug-confirmation-gate`** skill — fires every
...
curl -fsSL https://raw.githubusercontent.com/s-a-c/agent-skills/main/skills/s-a-c-debug-confirmation-gate/rules/s-a-c-debug-confirmation-gate.md \
  -o ~/.config/agents/rules/s-a-c-debug-confirmation-gate.md
# …or copy from the installed skill folder (path varies by agent/scope), e.g.
cp ~/.agents/skills/s-a-c-debug-confirmation-gate/rules/s-a-c-debug-confirmation-gate.md ~/.config/agents/rules/s-a-c-debug-confirmation-gate.md
```
