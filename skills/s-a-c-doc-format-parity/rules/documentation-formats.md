...
curl -fsSL https://raw.githubusercontent.com/s-a-c/agent-skills/main/skills/s-a-c-doc-format-parity/rules/documentation-formats.md \
  -o ~/.config/agents/rules/documentation-formats.md
# …or copy from the installed skill folder (path varies by agent/scope), e.g.
cp ~/.agents/skills/s-a-c-doc-format-parity/rules/documentation-formats.md ~/.config/agents/rules/documentation-formats.md
```
