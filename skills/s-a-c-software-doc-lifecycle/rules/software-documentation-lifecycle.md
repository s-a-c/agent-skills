...
curl -fsSL https://raw.githubusercontent.com/s-a-c/agent-skills/main/skills/s-a-c-software-doc-lifecycle/rules/software-documentation-lifecycle.md \
  -o ~/.config/agents/rules/software-documentation-lifecycle.md
# …or copy from the installed skill folder (path varies by agent/scope), e.g.
cp ~/.agents/skills/s-a-c-software-doc-lifecycle/rules/software-documentation-lifecycle.md ~/.config/agents/rules/software-documentation-lifecycle.md
```
